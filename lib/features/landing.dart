      ...
      child: Column(
        children: [
          Container(
            ...
            width: double.infinity,
            height: 40,
            // autogroupqdjwTqY (3AucCLr1qDnrXZkrDbqdJW)
            child: Row(
              ...
              children: [
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(
                      10 * fem, 0 * fem, 163 * fem, 0 * fem),

                  child: Image.asset(
                    'assets/mobile-app/images/vector-Wdc.png',
                    width: 26 * fem,
                    height: 22 * fem,
                  ),
                ),
                Container(
                  // vectorXqQ (67:26)
                  margin:
                      EdgeInsets.fromLTRB(2 * fem, 0 * fem, 169 * fem, 0 * fem),

                  child: Image.asset(
                    'assets/mobile-app/images/vector-rcW.png',
                    width: 30 * fem,
                    height: 28 * fem,
                  ),
                ),
                Container(
                  ...
                  child: Image.asset(
                    'assets/mobile-app/images/vector-NQW.png',
                    width: 19 * fem,
                    height: 19 * fem,
                  ),
                ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 18 * fem,
                          child: Image.asset(
                            'assets/mobile-app/images/vector-uUr.png',
                            width: 18 * fem,
                            height: 18 * fem,
                          ),
                        ),
