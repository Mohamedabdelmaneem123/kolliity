...
class Doctor {
  ...
  Doctor(this.profilePicture, this.username, this.fullName);
}
...
class _DoctorListState extends State<DoctorList> {
  final List<Doctor> doctors = List.generate(
    10,
      ...
      'MahmoudDoctor${10 + index}',
      'this is my doctor${10 + index}\'th full name',
    ),
  );

  List<Doctor> filteredStudents = [];
